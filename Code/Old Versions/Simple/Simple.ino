...
AudioSynthWaveform       waveform1;      //xy=1245,3382.5
AudioSynthWaveformModulated waveformMod14;  //xy=1689,3718.5
AudioSynthWaveformModulated waveformMod17;  //xy=1695,4011.5
AudioSynthWaveformModulated waveformMod13;  //xy=1697,3629.5
AudioSynthWaveformModulated waveformMod16;  //xy=1703,3922.5
AudioSynthWaveformModulated waveformMod15;  //xy=1717,3797.5
AudioSynthWaveformModulated waveformMod2;   //xy=1725,2594.5
AudioSynthWaveformModulated waveformMod7;   //xy=1727,3041.5
AudioSynthWaveformModulated waveformMod18;  //xy=1723,4090.5
AudioSynthWaveformModulated waveformMod11;  //xy=1728,3417.5
AudioSynthWaveformModulated waveformMod1;   //xy=1733,2506.5
AudioSynthWaveformModulated waveformMod10;  //xy=1741,3371.5
AudioSynthWaveformModulated waveformMod3;   //xy=1753,2673.5
AudioSynthWaveformModulated waveformMod4;   //xy=1753,2781.5
AudioSynthWaveformModulated waveformMod8;   //xy=1756,3103.5
AudioSynthWaveformModulated waveformMod12;  //xy=1756,3495.5
AudioSynthWaveformModulated waveformMod9;   //xy=1758,3184.5
AudioSynthWaveformModulated waveformMod5;   //xy=1782,2843.5
AudioSynthWaveformModulated waveformMod6;   //xy=1784,2924.5
AudioMixer4              mixer11;        //xy=1909,3726.5
AudioMixer4              mixer12;        //xy=1910,4037.5
AudioMixer4              mixer10;        //xy=1933,3434.5
AudioMixer4              mixer9;         //xy=1959,3100.5
AudioMixer4              mixer8;         //xy=2010,2878.5
AudioMixer4              mixer7;         //xy=2056,2664.5
AudioEffectEnvelope      envelope5;      //xy=2068,3767.5
AudioEffectEnvelope      envelope6;      //xy=2074,4060.5
AudioEffectEnvelope      envelope4;      //xy=2107,3466.5
AudioEffectEnvelope      envelope3;      //xy=2121,3066.5
AudioEffectEnvelope      envelope2;      //xy=2185,2894.5
AudioEffectEnvelope      envelope1;      //xy=2222,2772.5
AudioMixer4              mixer5;         //xy=2308,3583.5
AudioMixer4              mixer1;         //xy=2393,3099.5
AudioMixer4              mixer6;         //xy=2517.7500610351562,3538.5000610351562
AudioFilterBiquad        biquad1;        //xy=2656.25,3640
AudioFilterStateVariable filter1;        //xy=2835,3546.25
AudioEffectBitcrusher    bitcrusher1;    //xy=2925,3662.5
AudioMixer4              mixer2;         //xy=3184,3649.5
AudioMixer4              mixer13;        //xy=3495,3668.5
AudioAmplifier           amp1;           //xy=3774,3647.5
AudioOutputI2S           i2s1;           //xy=3947,3627.5
...
AudioConnection          patchCord51(mixer6, biquad1);
AudioConnection          patchCord52(biquad1, 0, filter1, 0);
AudioConnection          patchCord53(filter1, 2, bitcrusher1, 0);
AudioConnection          patchCord54(filter1, 2, mixer2, 0);
AudioConnection          patchCord55(bitcrusher1, 0, mixer2, 1);
AudioConnection          patchCord56(mixer2, 0, mixer13, 0);
AudioConnection          patchCord57(mixer13, amp1);
AudioConnection          patchCord58(amp1, 0, i2s1, 0);
AudioConnection          patchCord59(amp1, 0, i2s1, 1);
AudioControlSGTL5000     sgtl5000_1;     //xy=2584,2940.5
...
void setup() {
  ...
  biquad1.setLowpass(0, 16000, 0.708);

  // ladder1.frequency(16000);
...
void myNoteOn(byte channel, byte note, byte velocity) {
  ...
  // Serial.println(echoWetLevel);
  Serial.println("lp values:");
  Serial.println(lpCutValue);
  Serial.println(lpFreq);
  // Serial.println(lpResValue);

  Serial.println("hp values:");
...
void setValues(){
 ...
 //Destination
  ...
  lpFreq = map(lpCutValue, 0, 1023, 5000, 20000);
  // int lpRes = map(lpResValue, 0, 1023, 72, 500)/100;
  biquad1.setLowpass(0, lpFreq, 0.72);
    

  filter1.frequency(map(hpCutValue, 0, 1023, 20, 4000));
  filter1.resonance(map(hpResValue, 0, 1023, 72, 500)/100);
  ...
  mixer13.gain(0, echoDryLevel);
  mixer13.gain(1, echoWetLevel/2);
  mixer13.gain(2, echoWetLevel/2);
        ...
        case 7: {  // Amplitude envelope
          ...
          switch (i) {
            ...
            case 1:  // Encoder B (Sustain)
              ...
              Serial.println("setting sustain");
              Serial.println(envelopeValue);

              break;
            case 3:  // Encoder D (Release)
              setEnvelopes(-1, -1, -1, envelopeValue);  // Adjust release
              Serial.println("setting release");
              Serial.println(envelopeValue);
