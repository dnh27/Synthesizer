...
AudioSynthWaveformModulated waveformMod3;   //xy=737.5666198730469,591.5666809082031
AudioFilterBiquad        biquad1;        //xy=1016.5666656494141,477.56666564941406
AudioFilterBiquad        biquad2;        //xy=1066.566665649414,663.5666656494141
AudioEffectEnvelope      envelope1;      //xy=1435,497
AudioEffectEnvelope      envelope2;      //xy=1474.88330078125,652.88330078125
AudioMixer4              mixer1;         //xy=1670,578
AudioEffectDelay         delay1;         //xy=1842,581
AudioEffectFreeverb      freeverb1;      //xy=2040,565
AudioOutputI2S           i2s2; //xy=2230.33349609375,565.8333129882812
...
AudioConnection          patchCord7(waveformMod4, biquad2);
AudioConnection          patchCord8(waveformMod3, biquad2);
...
// AudioConnection          patchCord3(waveform1, 0, waveformMod1, 0);
// AudioConnection          patchCord4(waveform1, 0, waveformMod2, 0);
// AudioConnection          patchCord5(waveformMod1, envelope1);
// AudioConnection          patchCord6(waveformMod2, envelope1);
// AudioConnection          patchCord7(waveformMod3, envelope2);
// AudioConnection          patchCord8(waveformMod4, envelope2);
// AudioConnection          patchCord9(envelope1, 0, i2s2, 0);
// AudioConnection          patchCord10(envelope2, 0, i2s2, 1);
// AudioControlSGTL5000  sgtl5000_1; //xy=685.1666870117188,722
// // GUItool: end automatically generated code
...
void setup() {
  ...
  biquad1.setLowpass(0, 20000, 0.2);
  biquad2.setLowpass(0, 20000, 0.2);
}
